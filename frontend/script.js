...
function refreshData() {
    try { historyOrders = JSON.parse(localStorage.getItem("orderHistory")) || []; } catch(e) { historyOrders=[]; }
    try { tableTimers = JSON.parse(localStorage.getItem("tableTimers")) || {}; } catch(e) { tableTimers={}; }
    try { tableCarts = JSON.parse(localStorage.getItem("tableCarts")) || {}; } catch(e) { tableCarts={}; }
    try { tableStatuses = JSON.parse(localStorage.getItem("tableStatuses")) || {}; } catch(e) { tableStatuses={}; }
    try { tableCustomers = JSON.parse(localStorage.getItem("tableCustomers")) || {}; } catch(e) { tableCustomers={}; }
}
refreshData(); // 啟動時先讀取一次
